...
<p className="text-justify">La présente plateforme vise à établir un état des lieux des chances de promotion des femmes dans les grandes entreprises, par la voie d'un indice, l'IEHG. Chacune et chacun peut contribuer à ce suivi en renseignant les données - si possible publiques - relatives aux grands groupes.</p>	
          ...
          <div className="row">
		   ...
		   La formule de calcul de l'IEGH est la suivante:
                    <img src={formula} className="App-cartoon" alt="cartoon" title="Formule de l'IEGH." />
                </p>
               </div>
             </div>  
              <div className="card">
